                    ...
                    <div class="row mt-4 ">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="اضافه الدور (الطابق)" name="floor"  class="form-control" required value="{{ old('floor', $home->floor) }}">
                                @error('floor')
                                    <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="عدد الحمامات" name="number_of_bathroom"  class="form-control" required value="{{ old('number_of_bathroom',$home->number_of_bathroom) }}">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="عدد الغرف" name="number_of_bedroom"  class="form-control" required value="{{ old('number_of_bedroom',$home->number_of_bedroom) }}">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="عدد السراير" name="number_of_beds"  class="form-control" required value="{{ old('number_of_beds',$home->number_of_beds) }}">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="مساحة الشقه بالمتر" name="home_space"  class="form-control"  value="{{ old('home_space',$home->home_space) }}">
                                @error('home_space')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="قصي فتره زمنيه" name="maximum_period"  class="form-control"  value="{{ old('maximum_period',$home->maximum_period) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="سعر الشقه" name="price_for_home"  class="form-control"  value="{{ old('price_for_home',$home->price_for_home) }}">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="سعر الغرفه" name="price_for_bedroom"  class="form-control"  value="{{ old('price_for_bedroom',$home->price_for_home) }}">
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="سعر السرير" name="price_for_bed"  class="form-control"  value="{{ old('price_for_bed',$home->price_for_bed) }}">
                                @error('price_for_bed')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
