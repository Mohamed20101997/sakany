                ...
                <form method="POST" action="{{ route('owner.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label>العمر</label>
                                <input type="number" placeholder="اضافه العمر" name="age" min="16" class="form-control" required value="{{ old('age') }}">
                                @error('age')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <div class="toggle-flip">
                                    ...
                                    <label><input type="checkbox" value="1" name="statues" data-color="success" checked>
