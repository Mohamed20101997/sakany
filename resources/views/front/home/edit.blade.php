...
@section('contain')
    <main class="app-content_create">
        ...
        <h1 style="text-align: center">تعديل شقه</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile mb4">
                    <form method="POST" action="{{ route('add_home.update', $home->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="rent_type" required id="rent_type">
                                        <option value="home" {{old('rent_type', $home->rent_type) == 'شقه' ? 'selected' : ''}}>شقه</option>
                                        <option value="bed" {{old('rent_type', $home->rent_type) == 'سرير' ? 'selected' : ''}}>سرير</option>
                                        <option value="period_of_time" {{old('rent_type', $home->rent_type) == 'فتره زمنيه' ? 'selected' : ''}}>فتره زمنيه</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" placeholder="سعر الشقه" name="price_for_home" id="price_for_home"  class="form-control"  value="{{ old('price_for_home',$home->price_for_home) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" placeholder="سعر الغرفه" name="price_for_bedroom" id="price_for_bedroom"  class="form-control"  value="{{ old('price_for_bedroom',$home->price_for_bedroom) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" placeholder="سعر السرير" name="price_for_bed" id="price_for_bed"  class="form-control"  value="{{ old('price_for_bed',$home->price_for_bed) }}">
                                    @error('price_for_bed')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" placeholder="سعر اليوم" name="price_for_day" id="price_for_day"  class="form-control"  value="{{ old('price_for_day',$home->price_for_day) }}">
                                    @error('price_for_day')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
